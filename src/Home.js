                    ...
                    <Stack direction="row" spacing={4} marginTop="10">
                        <Link to={"buy-or-rentproperty"} className="href">
                            <Tooltip hasArrow margin="3" label="Buy or Rent Porperty" bg="#302b63">
                                <Button marginRight="1" color="#302b63" variant="solid" paddingRight="10" paddingLeft="10">
                                    BUY
                                </Button>
                            </Tooltip>
                        </Link>
                ...
                <div className="benefit center mt5" >
                    ...
                    <div className="benefitContent" >
                        <ul className="benefitLists">
                            ...
                            <li className="benefitList" data-aos="fade-up">Post any type of property for Rent and Sale</li>
                            <li className="benefitList" data-aos="fade-up"> Directly Contact with us for get any type of property on Rent and Buy</li>
